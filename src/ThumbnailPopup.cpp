...
void ThumbnailPopup::onDownload(CCObject* sender){
    std::string URL = fmt::format("https://raw.githubusercontent.com/Mcdoodle20/McGDPS-Level-Thumbnails/thumbs/{}.png", m_levelID);
...
void ThumbnailPopup::openDiscordServerPopup(CCObject* sender){
    ...
    createQuickPopup(
        ...
        [this](auto, bool btn2) {
            if (btn2) {
                CCApplication::sharedApplication()->openURL("https://discord.gg/p9dB4h8YZw");
            }
        }
    );
}
